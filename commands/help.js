...
module.exports = {
    ...
    callback: async ({ interaction }) => errorHandler(interaction, async () => {
        ...
        .setColor('#5865F2')
        .setDescription('A hall of fame bot with 28 commands that allow you save text, images, and audio. To create quotes you must first create authors, which have an image and name. Every type of quote (audio, image, regular, and multi) has an author, text, and up to three tags. I strongly recommend you check the Github readme for a more in depth explanation.')
